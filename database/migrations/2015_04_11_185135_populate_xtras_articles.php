...
class PopulateXtrasArticles extends Migration {
	...
	public function up()
	{
		$articles = [
			...
			['title' => "What the heck is Markdown and how do I use it?", 'slug' => "", 'summary' => "", 'content' => "Markdown is a plain-text formatting syntax that's converted into HTML. In several places throughout AnodyneXtras, we allow you to use Markdown to quickly and easily style your content instead of using HTML.", 'keywords' => 'markdown, html', 'tags' => [1, 2, 5]],
